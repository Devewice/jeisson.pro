...
5. Los HTML en `cv-dev/` y `cv-creativo/` no se sincronizan solos con los JSON; actualizar a mano si hace falta.
6. Responder en **español**. Commits y push solo si el usuario lo pide explícitamente.
